    ...
    const options = {
      ...
      body: JSON.stringify({
        profiles: [
          {
            email: userEmail,
            product_title_soldout: req.body.productTitle,
            product_handle_soldout: req.body.productHandle,
            product_variant_soldout: req.body.productVariant,
          },
        ],
      }),
    };

    let submitData = await fetch(`https://a.klaviyo.com/api/v2/list/${listID}/subscribe?api_key=${PRIVATE_API_KEY}`, options);
